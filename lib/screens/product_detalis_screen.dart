...
// import 'package:project/postscreen.dart';
...
// Future<List<Post>> fetchPostsbyid(int postid) async {
//   final response = await http.get('https://jsonplaceholder.typicode.com/posts/'+postid);
